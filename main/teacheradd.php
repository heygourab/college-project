...
if (isset($_SESSION['submit'])) {
    ...
    if (!mysqli_num_rows($selectphone) and !mysqli_num_rows($selectemail)) {
        $sql = "INSERT INTO teachers(fullname,email,phonenumber,gender,dob,status,department,state,pincode,locality,token)VALUES ('$fullname','$email','$phonenumber','$gender','$dob','$status','$department','$state','$pincode','$locality','$token')";
